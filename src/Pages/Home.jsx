...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ram3300", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/abbwabul-ramadhan-5658a530a/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/ramaaa.______/", label: "Instagram Profile" }
];
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Abbwabul ramadhan — Frontend Web Developer</title>
        <meta name="description" content="Website resmi Abbwabul ramadhan, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan." />
